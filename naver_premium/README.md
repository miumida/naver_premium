...
(초보자분들을 위해 설명을 드리면 config 파일 경로는 configuration.yaml 파일이 있는 경로 이고 hass.io를 설치 하신 분들은 /usr/share/hassio 경로 입니다)<br><hr><br>
...
경로는 아래와 같습니다.<br>
  ...
  `<config directory>/custom_components/naver_premium/manifest.json`<br><hr><br>
